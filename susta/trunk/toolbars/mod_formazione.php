...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<label for="attivita">Attività di formazione</label>
		<input type="text" name="for_descrizione" id="attivita" style="width: 40em;" value="<?php echo $_POST['for_descrizione']; ?>">
		<br>

		<label for="verifica">Verifica dell'efficacia</label>
		<select name="for_valutazione" id="verifica" value="<?php echo $_POST['for_valutazione']; ?>">
...
<p>
	...
	<a href="mod_ruolo.php?id=<?php echo $modulo->_session['campi']['for_dipendente']; ?>" target="_blank">Modifica / reparto ruolo</a>
	
	<a href="sch_indiv.php?id=<?php echo $modulo->_session['campi']['for_dipendente']; ?>" target="_blank">Stampa scheda individuale</a>
</p>
